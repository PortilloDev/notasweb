<footer>
    <div class="mt-16 flex flex-col items-center">
        <div class="mb-3 flex space-x-4"><a class="text-sm text-gray-500 transition hover:text-gray-600" target="_blank"
                rel="noopener noreferrer" href="mailto:	blognotasdesarrolloweb@gmail.com"><span class="sr-only">mail</span><svg
                ...
                </svg></a><a class="text-sm text-gray-500 transition hover:text-gray-600" target="_blank"
                rel="noopener noreferrer" href="https://github.com/PortilloDev"><span class="sr-only">github</span><svg
                ...
                rel="noopener noreferrer" href="https://www.youtube.com/channel/UC9nbS-Ami6aAnYTSr-Lm8Bw"><span class="sr-only">youtube</span><svg
                ...
                rel="noopener noreferrer" href="https://www.linkedin.com/in/iván-portillo-pérez"><span class="sr-only">linkedin</span><svg
                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                    class="fill-current text-gray-700 hover:text-blue-500 dark:text-gray-200 dark:hover:text-blue-400 h-6 w-6">
                    <path
                ...
                rel="noopener noreferrer" href="https://twitter.com/portillo_dev"><span class="sr-only">twitter</span><svg
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                    class="fill-current text-gray-700 hover:text-blue-500 dark:text-gray-200 dark:hover:text-blue-400 h-6 w-6">
                    <path
        ...
        <div class="mb-2 flex space-x-2 text-sm text-gray-500 dark:text-gray-400">
            <div>Iván Portillo Pérez</div>
            <div> • </div>
            <div>&copy; 2022, Notas Web</div>
        </div>
        <div class="mb-8 text-sm text-gray-500 dark:text-gray-400">
             <p class="text-muted text-center small p-0 mb-4">Todos los derechos
            reservados. | <a href="{{ route('contact') }}"> Contacto</a> </p>
        </div>
    </div>
</footer>
