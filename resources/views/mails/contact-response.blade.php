                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <p
                                                                                                                    ...
                                                                                                                    <span
                                                                                                                        class="specbundle2"><span
                                                                                                                            class="font1">Hola!!</span></span>
                                                                                                                </p>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </td>
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <p
                                                                                                                    ...
                                                                                                                    <span
                                                                                                                        class="font">{{ $data_mail['name'] }}</span>
                                                                                                                </p>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </td>
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div class="contentEditable"
                                                                                            ...
                                                                                            <p>
                                                                                                ...
                                                                                                <br>
                                                                                                También puedes
                                                                                                localizarme a traves de
                                                                                                mis redes sociales en
                                                                                                Linkedin, Instagram o
                                                                                                Twitter
                                                                                                <br>
                                                                                                <br>
                                                                                                Un saludo,
                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td valign='top'
                                                                                                                        width='52'>
                                                                                                                        <div
                                                                                                                            class="col-lg-2 mr-auto text-center">
                                                                                                                            <i
                                                                                                                                class="fab fa-linkedin-in fa-2x mb-2 text-muted"></i>
                                                                                                                            <!-- Make sure to change the email address in BOTH the anchor text and the link target below!-->
                                                                                                                            <a class="d-block"
                                                                                                                                href="https://www.linkedin.com/in/iván-portillo-pérez-a9676878"
                                                                                                                    ...
                                                                                                                    <td valign='top'
                                                                                                                        ...
                                                                                                                        <div
                                                                                                                            class="col-lg-2 mr-auto text-center">
                                                                                                                            <i
                                                                                                                                class="fab fa-twitter fa-2x mb-2 text-muted"></i>
                                                                                                                            <!-- Make sure to change the email address in BOTH the anchor text and the link target below!-->
                                                                                                                            <a class="d-block"
                                                                                                                                href="https://twitter.com/portillo_dev"
                                                                                                                    ...
                                                                                                                    <td valign='top'
                                                                                                                        ...
                                                                                                                        <div
                                                                                                                            class="col-lg-2 mr-auto text-center">
                                                                                                                            <i
                                                                                                                                class="fab fa-instagram fa-2x mb-2 text-muted"></i>
                                                                                                                            <!-- Make sure to change the email address in BOTH the anchor text and the link target below!-->
                                                                                                                            <a class="d-block"
                                                                                                                                href="https://www.instagram.com/portillo_dev/"
