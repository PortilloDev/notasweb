...
<section class="w-full h-full bg-center bg-cover" style="background-image: url({{ Storage::url($post->image->url)}})">
      ...
      <div class="flex flex-col lg:flex-row lg:space-x-12">
        ...
        <div class="w-full lg:w-1/4 m-auto mt-12 max-w-screen-sm">
            ...
            <div class="p-4 border-t border-b md:border md:rounded">
                ...
                <a href="{{ route('perfil') }}" class="px-2 py-1 text-gray-100 bg-green-700 flex w-full items-center justify-center rounded" style="background-color: #303a52">
                    Sobre mí 
